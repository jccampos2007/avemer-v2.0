...
<h2 class="text-3xl font-semibold text-gray-800 mb-6">Gestión de Grupos</h2>

<div class="flex justify-end mb-6">
    <a href="<?php echo BASE_URL; ?>grupo/create" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded shadow-md transition duration-200">
        <i class="fa fa-plus mr-2"></i> Crear Nuevo Grupo
    </a>
</div>
