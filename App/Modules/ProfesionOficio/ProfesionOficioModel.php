<?php
// php_mvc_app/App/Modules/ProfesionOficio/ProfesionOficioModel.php
namespace App\Modules\ProfesionOficio;

use App\Core\Database;
use PDO;

class ProfesionOficioModel
{
    private $pdo;
    private $table = 'profesion_oficio';
    ...
    public function getPaginatedProfesiones(array $params): array
    {
        $draw = $params['draw'] ?? 1;
