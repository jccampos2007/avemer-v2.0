        ...
        <form id="formMaestria" action="<?php echo $form_action; ?>" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" id="nombre" name="nombre" value="<?php echo $nombre_val; ?>" class="input-form focus:outline-none focus:shadow-outline" required maxlength="128">
                </div>

                <div>
                    <label for="numero" class="block text-gray-700 text-sm font-bold mb-2">Número:</label>
                    <input type="text" id="numero" name="numero" value="<?php echo $numero_val; ?>" class="input-form focus:outline-none focus:shadow-outline" maxlength="16">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="convenio" name="convenio" value="<?php echo $convenio_val; ?>" class="input-form focus:outline-none focus:shadow-outline" maxlength="16">
                </div>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($maestrias_abiertas as $abierto): ?>
                                <tr class="hover:bg-gray-50 transition duration-100">
                                    ...
                                    <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                                        <a href="<?php echo BASE_URL; ?>maestria_abierto/edit/<?php echo $abierto['id']; ?>" class="text-blue-600 hover:text-blue-800" title="Editar apertura">
...
<?php $page_js = 'asset/js/Maestria/maestria.js?1'; ?>