...
<h2 class="text-3xl font-semibold text-gray-800 mb-6">Gestión de Eventos</h2>

<div class="flex justify-end mb-4">
    <?php if ($canCreate): ?>
    <a href="<?php echo BASE_URL; ?>evento/create" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
        Crear Nuevo Evento
    </a>
    <?php endif; ?>
</div>
    ...
    <table id="eventoTable" class="min-w-full leading-normal display responsive nowrap" style="width:100%">
        <thead>
            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                ...
                <th class="py-3 px-6 text-left">Siglas</th>
