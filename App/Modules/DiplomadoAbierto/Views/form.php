...
$costo_val = htmlspecialchars($diplomado_abierto_data['costo'] ?? '0.00');
$inicial_val = htmlspecialchars($diplomado_abierto_data['inicial'] ?? '0.00');
?>
...
<div class="w-full space-y-6">
    ...
    <div id="form_main_card" class="bg-white p-8 rounded-lg shadow-md border border-gray-100">
        <div id="form_header_row" class="flex justify-between items-center mb-6 border-b pb-3">
            <h3 class="text-2xl font-bold text-gray-800"><?php echo ($is_edit) ? 'Editar Diplomado Abierto' : 'Crear Nuevo Diplomado Abierto'; ?></h3>
            <?php if ($is_edit): ?>
    ...
    <!-- TARJETA 2: Alumnos Inscritos (Solo visible en modo Edición) -->
    <?php if ($is_edit): ?>
        <div class="bg-white p-8 rounded-lg shadow-md border border-gray-100">
                        ...
                        <tbody>
                            <?php foreach ($inscritos as $ins): ?>
                                <tr class="hover:bg-gray-50 transition duration-100">
                                    ...
                                    <td class="px-5 py-4 border-b border-gray-200 bg-white text-sm">
                                        <a href="<?php echo BASE_URL; ?>inscripcion_diplomado/edit/<?php echo $ins['inscripcion_id']; ?>" class="text-blue-600 hover:text-blue-800" title="Editar inscripción">
            ...
            <?php else: ?>
                <div class="p-4 bg-gray-50 border border-gray-100 rounded text-gray-500 text-sm flex items-center">
                    ...
                    No hay alumnos inscritos en este diplomado abierto actualmente.
                </div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
...
<?php $page_js = 'asset/js/DiplomadoAbierto/diplomado_abierto.js?2'; ?>