...
$page_title = $is_edit ? 'Editar Evento Abierto' : 'Crear Nuevo Evento Abierto';
...
<div class="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
    ...
    <form id="formEventoAbierto" action="<?php echo $form_action; ?>" method="POST"
        ...
        <div class="mb-4">
            ...
            <select id="evento_id" name="evento_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo BASE_URL; ?>evento_abierto" class="inline-block align-baseline font-bold text-sm text-gray-600 hover:text-gray-800">
                Cancelar
            </a>
        </div>
    </form>
