$(document).ready(function () {
    ...
    if (formDuracion.length === 0) {
            ...
            "columns": [
                ...
                { "data": 1 },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                        <a href="${BASE_URL_JS}duracion/edit/${row[0]}" class="btn-action btn-action-edit"><i class="fas fa-edit"></i></a>
                        <a href="${BASE_URL_JS}duracion/delete/${row[0]}" class="btn-action btn-action-delete" title="Eliminar"><i class="fas fa-trash-alt"></i></a>
                    `;
                    }
                }
            ],
        ...
        $("#duracionTable").on("click", ".btn-action-delete", function (e) {
            e.preventDefault();
