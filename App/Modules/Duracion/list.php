...
<h2 class="text-3xl font-semibold text-gray-800 mb-6">Gestión de Duraciones</h2>

<div class="flex justify-end mb-4">
    <a href="<?php echo BASE_URL; ?>duracion/create" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
