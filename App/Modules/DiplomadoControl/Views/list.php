<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-100 overflow-hidden p-4">
        ...
        <table id="diplomadocontrolTable" class="w-full min-w-full leading-normal display responsive">
            <thead>
                <tr>
