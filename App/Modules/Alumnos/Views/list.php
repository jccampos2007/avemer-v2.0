...
$canCreate = \App\Core\Auth::hasPermission('alumnos', 'crear');
$canEdit = \App\Core\Auth::hasPermission('alumnos', 'modificar');
$canDelete = \App\Core\Auth::hasPermission('alumnos', 'eliminar');
?>
