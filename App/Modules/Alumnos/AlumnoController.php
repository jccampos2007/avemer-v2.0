...
class AlumnoController extends Controller
{
    ...
    public function store(): void
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // Manejo de archivos BLOB (foto, imagen)
            ...
            try {
                if ($this->alumnoModel->create($data)) {
                    Auth::setFlashMessage('success', 'Alumno creado correctamente.');
                    $this->redirect('alumnos');
                } else {
                    Auth::setFlashMessage('error', 'Error al crear el alumno.');
                    $this->redirect('alumnos/create');
                }
            } catch (\PDOException $e) {
                Auth::setFlashMessage('error', 'Error de base de datos al crear alumno: ' . $e->getMessage());
                $this->redirect('alumnos/create');
            }
        } else {
            $this->redirect('alumnos');
