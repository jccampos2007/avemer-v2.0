<?php
// app/Modules/PreinscripcionDiplomado/Views/form.php

// No hay edición, solo creación
...
<?php $page_js = 'asset/js/PreinscripcionDiplomado/preinscripcion_diplomado.js?' . $randomValue; ?>