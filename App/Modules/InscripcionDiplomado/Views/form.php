    ...
    <form id="formInscripcionDiplomado" action="<?php echo $form_action; ?>" method="POST"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            <div class="lg:col-span-2">
                ...
                <input type="text" id="diplomado_abierto_autocomplete" class="input-form focus:outline-none focus:shadow-outline" placeholder="Buscar diplomado abierto..." value="<?php echo $diplomado_abierto_nombre_val; ?>" required>
