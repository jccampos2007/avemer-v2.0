            ...
            <ul class="text-white space-y-2">
                ...
                <li x-data="{ talleresOpen: <?php echo $isTalleresActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="talleresOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>cursos" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'cursos') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-graduation-cap mr-2"></i> Talleres</a></li>
                        ...
                        <li><a href="<?php echo BASE_URL; ?>inscripcion_curso" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'inscripcion_curso') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-pen-to-square mr-2"></i> Inscripción</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ eventosOpen: <?php echo $isEventosActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="eventosOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>evento" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'evento') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-calendar-day mr-2"></i> Eventos</a></li>
                        <li><a href="<?php echo BASE_URL; ?>evento_abierto" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'evento_abierto') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-unlock mr-2"></i> Apertura Evento</a></li>
                        <li><a href="<?php echo BASE_URL; ?>inscripcion_evento" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'inscripcion_evento') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-pen-to-square mr-2"></i> Inscripción Evento</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ pagosOpen: <?php echo $isPagosActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="pagosOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>cuota" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'cuota') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-coins mr-2"></i> Cuota</a></li>
                        <li><a href="<?php echo BASE_URL; ?>pago" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'pago') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-money-bill-1-wave mr-2"></i> Pagos</a></li>
                        <li><a href="<?php echo BASE_URL; ?>compensar" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'compensar') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-unlock mr-2"></i> Compensar</a></li>
                        <li><a href="<?php echo BASE_URL; ?>cronograma" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'cronograma') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-exchange mr-2"></i> Cronograma</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ mensajesOpen: <?php echo $isMensajesActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="mensajesOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>listacorreo" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'listacorreo' || $module == 'correo') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-list-ul mr-2"></i> Lista De Correo</a></li>
                        <li><a href="<?php echo BASE_URL; ?>mensajes" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'mensajes') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-envelope mr-2"></i> Mensaje</a></li>
                        <li><a href="<?php echo BASE_URL; ?>listaenvio" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'listaenvio') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-envelope mr-2"></i> Lista De Envio</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ mantenimientoOpen: <?php echo $isMantenimientoActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="mantenimientoOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>sede" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'sede') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-building mr-2"></i> Sedes</a></li>
                        <li><a href="<?php echo BASE_URL; ?>banco" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'banco') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-institution mr-2"></i> Bancos</a></li>
                        <li><a href="<?php echo BASE_URL; ?>duracion" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'duracion') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-clock mr-2"></i> Duración</a></li>
                        <li><a href="<?php echo BASE_URL; ?>profesion_oficio" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'profesion_oficio') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-person-digging mr-2"></i> Profesión u Oficio</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ seguridadOpen: <?php echo $isSeguridadActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="seguridadOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>users/group" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'users/group') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-user-group mr-2"></i> Grupo</a></li>
                        <li><a href="<?php echo BASE_URL; ?>users" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'users') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-user-circle mr-2"></i> Usuario</a></li>
                        <li><a href="<?php echo BASE_URL; ?>users/permissions" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($module == 'users/permissions') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-money mr-2"></i> Permisos Grupo</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
