...
$isRegistroActive = in_array(explode('/', $relativeUri)[0], ['alumnos', 'docentes', 'coordinadores']);
$isTalleresActive = in_array(explode('/', $relativeUri)[0], ['cursos', 'cursos_abiertos', 'inscripcion_curso']);
$isEventosActive = in_array(explode('/', $relativeUri)[0], ['evento', 'evento_abierto', 'inscripcion_evento']);
$isDiplomadosActive = in_array(explode('/', $relativeUri)[0], ['diplomado', 'capitulo', 'diplomado_abierto', 'inscripcion_diplomado', 'preinscripcion_diplomado']);
$isMaestriasActive = in_array(explode('/', $relativeUri)[0], ['maestria', 'maestria_abierto', 'inscripcion_maestria']);
$isPagosActive = in_array(explode('/', $relativeUri)[0], ['cuota', 'pago', 'compensar', 'cronograma']);
$isMensajesActive = in_array(explode('/', $relativeUri)[0], ['listacorreo', 'mensajehtml', 'listaenvio']);
$isReportesActive = strpos($relativeUri, 'rpt_') === 0;
$isMantenimientoActive = in_array(explode('/', $relativeUri)[0], ['sede', 'banco', 'duracion', 'profesion']);
$isSeguridadActive = in_array(explode('/', $relativeUri)[0], ['users']);
?>
            ...
            <ul class="text-white space-y-2">
                <li>
                    <a href="<?php echo BASE_URL; ?>dashboard"
                        class="block py-2 px-4 rounded hover:bg-gray-700 transition duration-200 <?php echo ($relativeUri == 'dashboard' || empty($relativeUri)) ? 'bg-gray-700 text-blue-300 font-semibold' : ''; ?>">
                ...
                <li x-data="{ talleresOpen: <?php echo $isTalleresActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="talleresOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>cursos" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'cursos') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-graduation-cap mr-2"></i> Talleres</a></li>
                        <li><a href="<?php echo BASE_URL; ?>cursos_abiertos" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'cursos_abiertos') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-unlock mr-2"></i> Apertura</a></li>
                        <li><a href="<?php echo BASE_URL; ?>inscripcion_curso" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'inscripcion_curso') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-pen-to-square mr-2"></i> Inscripción</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ eventosOpen: <?php echo $isEventosActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="eventosOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>evento" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'evento') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-calendar-day mr-2"></i> Eventos</a></li>
                        <li><a href="<?php echo BASE_URL; ?>evento_abierto" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'evento_abierto') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-unlock mr-2"></i> Apertura Evento</a></li>
                        <li><a href="<?php echo BASE_URL; ?>inscripcion_evento" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'inscripcion_evento') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-pen-to-square mr-2"></i> Inscripción Evento</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ diplomadosOpen: <?php echo $isDiplomadosActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="diplomadosOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>diplomado" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'diplomado') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-graduation-cap mr-2"></i> Diplomados</a></li>
                        <li><a href="<?php echo BASE_URL; ?>capitulo" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'capitulo') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-list-alt mr-2"></i> Capítulos</a></li>
                        <li><a href="<?php echo BASE_URL; ?>diplomado_abierto" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'diplomado_abierto') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-unlock mr-2"></i> Apertura</a></li>
                        <li><a href="<?php echo BASE_URL; ?>inscripcion_diplomado" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'inscripcion_diplomado') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fas fa-user-check mr-2"></i> Inscripción</a></li>
                        <li><a href="<?php echo BASE_URL; ?>preinscripcion_diplomado" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'preinscripcion_diplomado') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-pen-to-square mr-2"></i> Pre-Inscripción</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ maestriasOpen: <?php echo $isMaestriasActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="maestriasOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>maestria" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'maestria') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-graduation-cap mr-2"></i> Maestrías</a></li>
                        <li><a href="<?php echo BASE_URL; ?>maestria_abierto" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'maestria_abierto') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-unlock mr-2"></i> Apertura</a></li>
                        <li><a href="<?php echo BASE_URL; ?>inscripcion_maestria" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'inscripcion_maestria') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fas fa-user-check mr-2"></i> Inscripción</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ pagosOpen: <?php echo $isPagosActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="pagosOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>cuota" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'cuota') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-coins mr-2"></i> Cuota</a></li>
                        <li><a href="<?php echo BASE_URL; ?>pago" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'pago') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa-solid fa-money-bill-1-wave mr-2"></i> Pagos</a></li>
                        <li><a href="<?php echo BASE_URL; ?>compensar" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'compensar') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-unlock mr-2"></i> Compensar</a></li>
                        <li><a href="<?php echo BASE_URL; ?>cronograma" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'cronograma') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-exchange mr-2"></i> Cronograma</a></li>
                    </ul>
                </li>
                ...
                <li x-data="{ reportesOpen: <?php echo $isReportesActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="reportesOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>rpt_detalle_diplomado" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'rpt_detalle_diplomado') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-unlock mr-2"></i> Diplomados</a></li>
                        <li><a href="<?php echo BASE_URL; ?>rpt_global_pago" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'rpt_global_pago') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-exchange mr-2"></i> Pagos</a></li>
                        <li><a href="<?php echo BASE_URL; ?>rpt_pagos_por_confirmar" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'rpt_pagos_por_confirmar') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-exchange mr-2"></i> Pagos por Confirmar</a></li>
                        <li><a href="<?php echo BASE_URL; ?>rpt_pagos_pendientes" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'rpt_pagos_pendientes') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-exchange mr-2"></i> Pagos pendientes</a></li>
                        <li><a href="<?php echo BASE_URL; ?>rpt_morosos" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'rpt_morosos') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-exchange mr-2"></i> Morosos</a></li>
                ...
                <li x-data="{ seguridadOpen: <?php echo $isSeguridadActive ? 'true' : 'false'; ?> }">
                    ...
                    <ul x-show="seguridadOpen" x-transition.opacity class="pl-4 mt-1 space-y-1 text-sm text-gray-300">
                        <li><a href="<?php echo BASE_URL; ?>users/group" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'users/group') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-user-group mr-2"></i> Grupo</a></li>
                        <li><a href="<?php echo BASE_URL; ?>users" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'users') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-user-circle mr-2"></i> Usuario</a></li>
                        <li><a href="<?php echo BASE_URL; ?>users/permissions" class="block py-1.5 px-3 rounded hover:bg-gray-600 transition <?php echo ($relativeUri == 'users/permissions') ? 'bg-gray-600 text-white font-bold' : ''; ?>"><i class="fa fa-money mr-2"></i> Permisos Grupo</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
