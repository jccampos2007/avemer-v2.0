        ...
        inscripcionEventoTable.DataTable({
            ...
            "ajax": {
                ...
                "error": function (xhr, error, thrown) {
                    ...
                    alert('Error al cargar los datos de inscripciones de evento. Por favor, revisa la consola para más detalles.');
                }
            },
            "columns": [
                { "data": 0 }, // ID
                ...
                { // Columna de Acciones
                    ...
                    "render": function (data, type, row) {
                        ...
                        return `
                            <a href="inscripcion_evento/edit/${row[0]}" class="btn btn-default" title="Editar"><i class="fas fa-edit fs-5"></i></a>
                            <a href="inscripcion_evento/delete/${row[0]}" class="btn btn-default btn-delete" title="Eliminar"><i class="fas fa-trash-alt fs-5"></i></a>
                        `;
                    }
                }
            ],
