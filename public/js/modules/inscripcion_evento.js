            ...
            "columns": [
                ...
                { // Columna de Acciones
                    ...
                    "render": function (data, type, row) {
                        ...
                        return `
                            <a href="inscripcion_evento/edit/${row[0]}" class="btn btn-default"><i class="fas fa-edit fs-5"></i></a>
                            <a href="inscripcion_evento/delete/${row[0]}" class="btn btn-default"><i class="fas fa-trash-alt fs-5"></i></a>
                        `;
                    }
                }
            ],
