        ...
        var coordinadoresTable = $('#coordinadoresTable').DataTable({
            ...
            "columns": [
                ...
                { "data": 4 }, // Columna 4: Correo
                {
                    ...
                    render: function (data, type, row) {
                        return `
                        <a href="coordinadores/edit/${row[0]}" class="btn btn-default"><i class="fas fa-edit fs-5"></i></a>
                        <a href="coordinadores/delete/${row[0]}" class="btn btn-default"><i class="fas fa-trash-alt fs-5"></i></a>
                    `;
                    }
                }
            ],
