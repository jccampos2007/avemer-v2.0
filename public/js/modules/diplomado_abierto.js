            ...
            "columns": [
                ...
                { // Columna para Acciones
                    ...
                    "render": function (data, type, row) {
                        ...
                        return `
                            <a href="diplomado_abierto/edit/${row[0]}" class="btn btn-default" title="Editar"><i class="fas fa-edit fs-5"></i></a>
                            <a href="diplomado_abierto/delete/${row[0]}" class="btn btn-default btn-delete" title="Eliminar"><i class="fas fa-trash-alt fs-5"></i></a>
                        `;
                    }
                }
            ],
